...
esp_err_t context_build_system_prompt(char *buf, size_t size)
{
    ...
    off += snprintf(buf + off, size - off,
        ...
        "- camera_capture: Capture a photo using the device camera.\n"
        "- display: Draw shapes, text, symbols on the 412x412 round screen.\n"
        "- get_system_info: Get battery, WiFi, and system info.\n"
        "- face: Control the robot face expression! ALWAYS use this tool when user asks to show "
        "any emotion or expression. Available: neutral, happy, sad, angry, surprised, love, "
        "sleepy, wink, thinking, excited, scared, cool, cry, dizzy, shy, smug.\n\n"
        "IMPORTANT: When the user asks you to smile, look sad, show any expression/emotion, or "
        "change your face, you MUST call the 'face' tool with the matching emotion name. "
        "Do NOT just reply with text — actually change the face on screen!\n\n"
